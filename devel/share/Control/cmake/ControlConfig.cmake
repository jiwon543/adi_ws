...
if("TRUE" STREQUAL "TRUE")
  set(Control_SOURCE_PREFIX /root/adi_ws/src/Control)
  set(Control_DEVEL_PREFIX /root/adi_ws/devel)
  set(Control_INSTALL_PREFIX "")
  set(Control_PREFIX ${Control_DEVEL_PREFIX})
else()
  set(Control_SOURCE_PREFIX "")
  set(Control_DEVEL_PREFIX "")
  set(Control_INSTALL_PREFIX /root/adi_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'Control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/adi_ws/src/Control/${idir}'.  ${_report}")
    endif()
