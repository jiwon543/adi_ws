...
if("TRUE" STREQUAL "TRUE")
  set(Perception_SOURCE_PREFIX /root/adi_ws/src/Perception)
  set(Perception_DEVEL_PREFIX /root/adi_ws/devel)
  ...
  set(Perception_INSTALL_PREFIX /root/adi_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'Perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/adi_ws/src/Perception/${idir}'.  ${_report}")
    endif()
