...
def parse_opt():
    ...
    #parser.add_argument('--source', type=str, default=ROOT / 'data/images', help='file/dir/URL/glob, 0 for webcam') #摄像头测试
    parser.add_argument('--source', type=str, default='videos/autopilot_test.mp4', help='source')
