...
def identify_publisher(names,classes,number,position,acc):
	# 创建一个Publisher，发布名为/identify_info的topic
    identify_info_pub = rospy.Publisher('/identify_info', identify, queue_size=10)
    ...
    identify_msg.image_number = image_number;
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='videos/altman_test.mp4', help='source')
