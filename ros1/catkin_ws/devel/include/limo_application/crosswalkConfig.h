...
namespace limo_application
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(crosswalkConfig &config, const crosswalkConfig &max, const crosswalkConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const crosswalkConfig &config1, const crosswalkConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, crosswalkConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const crosswalkConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, crosswalkConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const crosswalkConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const crosswalkConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, crosswalkConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
