...
namespace limo_application
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(image_processingConfig &config, const image_processingConfig &max, const image_processingConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const image_processingConfig &config1, const image_processingConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, image_processingConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const image_processingConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, image_processingConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const image_processingConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const image_processingConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, image_processingConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
