...
class PedestrianNode:
    def __init__(self):
        rospy.init_node('modified_pedestrian_node')
        
        # Parameters (from yaml/cfg)
        self.scan_angle = rospy.get_param('~scan_angle', 28.0)
        self.detect_distance = rospy.get_param('~detect_distance', 0.38)
        ...
        self.pub_state_status = rospy.Publisher('/state_manager/lane_state', String, queue_size=1)
    ...
    def control_loop(self, event):
        ...
        if min_dist < self.stop_distance:
            ...
            self.pub_state_status.publish(String(data="WAITING_PEDESTRIAN"))
            ...
            self.pedestrian_detected = False
            self.pub_state_status.publish(String(data="LANE_FOLLOWING"))
